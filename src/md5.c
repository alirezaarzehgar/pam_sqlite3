...
/**
 * @brief Constants are the integer part of the sines of integers (in radians) * 2^32.
 * 
 */
const uint32_t k[64] = {
...
/**
 * @brief r specifies the per-round shift amounts
 * 
 */
...
/**
 * @brief leftrotate function definition
 * 
 */
 ...
 * @return char* 
 */
char *str2md5(uint8_t *digest)
{
    char *md5string = malloc(sizeof(char) * 32);
    for (int i = 0; i < 16; ++i)
